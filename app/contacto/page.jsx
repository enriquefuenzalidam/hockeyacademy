                  ...
                  <form className={`pb-12 px-6 gx:px-0`}>
                      ...
                      <div className={`flex flex-col md:flex-row gap-4 lg:gap-8 mb-8 lg:mb-20`}>
                          ...
                          <div className="relative w-full">
                              <label className={`absolute top-3 left-3 text-white text-base transition-all duration-300 transform origin-top-left pointer-events-none`}>
                                  Nombre
                              </label>
                      ...
                      <div className={`mb-8 lg:mb-12 border-2 border-solid border-white rounded-lg p-4`}>
                          ...
                          <textarea className={`w-full border-none bg-transparent text-white font-Roboto text-base md:text-md lg:text-md xl:text-lg p-2 md:p-3 lg:p-3 xl:p-3 focus:outline-none`} rows='4' placeholder='Mensaje'></textarea>
                      </div>
