    ...
    <div className={`flex-grow max-w-8xl mx-auto flex justify-center items-center w-full`}>
      <div className={`bg-[#12214d] bg-opacity-60 p-8 rounded-lg shadow-lg w-full md:w-5/6 lg:w-4/5 xl:w-3/4`}>
        ...
        <form className={`pb-12 px-6 gx:px-0`}>
          ...
          {/* Textarea */}
          <textarea className={`block mt-5 w-full border-2 border-solid border-white bg-transparent text-white font-Roboto text-base md:text-md lg:text-md xl:text-lg p-2 md:p-3 lg:p-3 xl:p-3 focus:outline-none`} rows='8' placeholder='Mensaje'></textarea>
