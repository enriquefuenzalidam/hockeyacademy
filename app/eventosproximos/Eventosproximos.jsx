...
export default function Eventosproximos() {
    ...
    return (
        <PlantillaUno
            ...
            contentc={
                <>
                    <section className={` relative mx-auto max-w-5xl pt-28 pb-10`}>
                        <h2 data-aos-once="true" data-aos="fade-up" className={` text-center tracking-wide font-BebasNeue text-blue-950 text-4xl mx-8 mb-6`}>Hockey Academy Camp en Videos</h2>
