                ...
                <div className={` relative w-full py-32 `}>
                    ...
                    <section className={`relative block mx-8`}>
                        <div className={`block mx-auto max-w-5xl pt-16`}>
                            ...
                            <div className={` rounded-md overflow-hidden relative shadow-md shadow-[rgba(0,0,0,0.6)] mt- mx-auto my-8 w-full md:w-4/5 aspect-[24/11] `}>
                            ...
                            <p className={` text-blue-950 font-Roboto text-lg leading-relaxed text-justify hyphens-auto indent-5 `}>
